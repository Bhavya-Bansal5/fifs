...
urls = {
    "most_wickets": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/10011-mostwickets.js?callback=onmostwickets&_=1742828585449",
    "top_run_scorers": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/10011-toprunsscorers.js?callback=ontoprunsscorers&_=1742828585448",
    "match_schedule": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/archievefeeds/10011-matchschedule.js?MatchSchedule=_jqjsp&_1742828586310="
}
...
remove_existing_csv("New Folder/most_wickets_2019")
fetch_and_save(urls["most_wickets"], "onmostwickets", "New Folder/most_wickets_2019")

remove_existing_csv("top_run_scorers_2019")
fetch_and_save(urls["top_run_scorers"], "ontoprunsscorers", "New Folder/top_run_scorers_2019")
...
remove_existing_csv("match_schedule_2019")
fetch_and_save(urls["match_schedule"], "MatchSchedule", "match_schedule_2019", match_schedule_columns)