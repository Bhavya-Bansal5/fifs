...
urls = {
    "most_wickets": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/60-mostwickets.js?callback=onmostwickets&_=1742828221535",
    "top_run_scorers": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/60-toprunsscorers.js?callback=ontoprunsscorers&_=1742828221534",
    "match_schedule": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/60-matchschedule.js?MatchSchedule=_jqjsp&_1742828222334="
}
...
remove_existing_csv("New Folder/most_wickets_2022")
fetch_and_save(urls["most_wickets"], "onmostwickets", "New Folder/most_wickets_2022")

remove_existing_csv("New Folder/top_run_scorers_2022")
fetch_and_save(urls["top_run_scorers"], "ontoprunsscorers", "New Folder/top_run_scorers_2022")
...
remove_existing_csv("match_schedule_2022")
fetch_and_save(urls["match_schedule"], "MatchSchedule", "match_schedule_2022", match_schedule_columns)