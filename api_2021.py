...
urls = {
    "most_wickets": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/10013-mostwickets.js?callback=onmostwickets&_=1742828323591",
    "top_run_scorers": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/10013-toprunsscorers.js?callback=ontoprunsscorers&_=174282832359",
    "match_schedule": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/archievefeeds/10013-matchschedule.js?MatchSchedule=_jqjsp&_1742828324224="
}
...
remove_existing_csv("New Folder/most_wickets_2021")
fetch_and_save(urls["most_wickets"], "onmostwickets", "New Folder/most_wickets_2021")

remove_existing_csv("New Folder/top_run_scorers_2021")
fetch_and_save(urls["top_run_scorers"], "ontoprunsscorers", "New Folder/top_run_scorers_2021")
...
remove_existing_csv("match_schedule_2021")
fetch_and_save(urls["match_schedule"], "MatchSchedule", "match_schedule_2021", match_schedule_columns)