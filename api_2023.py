...
urls = {
    "most_wickets": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/107-mostwickets.js?callback=onmostwickets&_=1742828092110",
    "top_run_scorers": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/stats/107-toprunsscorers.js?callback=ontoprunsscorers&_=1742828092109",
    "match_schedule": "https://ipl-stats-sports-mechanic.s3.ap-south-1.amazonaws.com/ipl/feeds/107-matchschedule.js?MatchSchedule=_jqjsp&_1742828093113="
}
...
remove_existing_csv("New Folder/most_wickets_2023")
fetch_and_save(urls["most_wickets"], "onmostwickets", "New Folder/most_wickets_2023")

remove_existing_csv("New Folder/top_run_scorers_2023")
fetch_and_save(urls["top_run_scorers"], "ontoprunsscorers", "New Folder/top_run_scorers_2023")
...
remove_existing_csv("match_schedule_2023")
fetch_and_save(urls["match_schedule"], "MatchSchedule", "match_schedule_2023", match_schedule_columns)